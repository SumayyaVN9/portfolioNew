        ...
        <section className="contact" id="contact">
            <Container>
                <Row className="align-items-center"> 
                    <Col md={6}>
                    {/* <img src={contactImag} alt="Contact Us"/> */}
                    </Col>
                    <Col md={6} className="center-form">
                    <h2 style={{ marginLeft: "200px" }}>Get In Touch</h2>
                    <form onSubmit={handleSubmit}>
                        <Row>
                            ...
                            <textarea rows="6" value={formDetails.message} placeholder=" Message" onChange={(e) => onFormUpdate('message', e.target.value)}/>
                                <Button type="submit" style={{ marginLeft: "250px"}}><span>{buttonText}</span></Button>
                            </Col>
                            {
                                status.message &&
                                <Col>
